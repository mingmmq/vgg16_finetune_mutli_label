...
text="--lr 1e-4 --epochs 1 --pv VOC2007"
python vgg16_pascal.py $text | tee log.out
para=$(echo $text | tr -d ' ')
save_images $para

#custom loss function with default weights
text="--lr 1e-4 --epochs 1 --pv VOC2007 --lf yes"
python vgg16_pascal.py $text | tee log.out
para=$(echo $text | tr -d ' ')
save_images $para

text="--lr 1e-4 --epochs 1 --pv VOC2007 --lf yes --lw 300"
python vgg16_pascal.py $text | tee log.out
para=$(echo $text | tr -d ' ')
save_images $para

text="--lr 1e-4 --epochs 1 --pv VOC2007 --lf yes --rw 300"
python vgg16_pascal.py $text | tee log.out
para=$(echo $text | tr -d ' ')
save_images $para
...
text="--lr 1e-3 --epochs 1 --pv VOC2007"
python vgg16_pascal.py $text | tee log.out
para=$(echo $text | tr -d ' ')
save_images $para

text="--lr 1e-3 --epochs 1 --pv VOC2007 --lf yes"
python vgg16_pascal.py $text | tee log.out
para=$(echo $text | tr -d ' ')
save_images $para

text="--lr 1e-3 --epochs 1 --pv VOC2007 --lf yes --lw 300"
python vgg16_pascal.py $text | tee log.out
para=$(echo $text | tr -d ' ')
save_images $para

text="--lr 1e-3 --epochs 1 --pv VOC2007 --lf yes --rw 300"
python vgg16_pascal.py $text | tee log.out
para=$(echo $text | tr -d ' ')
save_images $para
