...
def getImageAndLabels(data_path, last_name):
    files = [file for file in os.listdir(data_path) if file.__contains__(last_name)]
    files = sorted(files)
    print(files)
    ...
    for file in files:
        ...
        with open(os.path.join(data_path,file)) as f:
            ...
            for img_path in lines:
                ...
                img_path = os.path.join('VOC2012', 'JPEGImages', img_path.split()[0] + ".jpg")
